...
urlpatterns = [
    ...
    path('urunler/', views.category, name='ürünler'),
    path('urun/', views.product_detail, name='ürün_detay'),
    path('galeri/', views.gallery, name='galeri'),
    path('search/', views.product_search, name='product_search'),
    path('kategori/<int:id>/<slug:slug>/', views.category_detail, name='kategori_detay'),
    path('urun/<int:id>/<slug:slug>/', views.product_detail, name='kategori_detay'),
